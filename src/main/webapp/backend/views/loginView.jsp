...
<div class="p-5">
    ...
    <form method="POST" action="login" class="user">
        ...
        <hr>
        <a href="${pageContext.request.contextPath}/backend/home" class="btn btn-warning btn-user btn-block">
             Cancel
        </a>
        <hr>
    ...
    <hr>
    <div class="text-center">
        <a class="small" href="${pageContext.request.contextPath}/backend/userManage">Forgot Password?</a>
    </div>
    <div class="text-center">
        <a class="small" href="${pageContext.request.contextPath}/backend/userAdd">Create an Account!</a>
    </div>
</div>
</body>
</html>
